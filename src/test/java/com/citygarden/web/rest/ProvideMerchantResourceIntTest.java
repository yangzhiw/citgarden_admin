...
public class ProvideMerchantResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(provideMerchantResource, "provideMerchantRepository", provideMerchantRepository);
    ...
    public void createProvideMerchant() throws Exception {
        ...
        restProvideMerchantMockMvc.perform(post("/api/provideMerchants")
                ...
                .content(TestUtil.convertObjectToJsonBytes(provideMerchant)))
